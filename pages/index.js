...
class Home extends React.Component{
  ...
  render(){
    return (
      ...
      <h2 className={styles.announcements}>For Assistance</h2><h4 className={styles.assistanceTitles}>Hours of Operation: </h4><p className={styles.description}>Tuesday, Friday, Saturday from 10:00AM - Noon, Wednesday 4:00 - 6:00PM</p><ul className={styles.list}>
